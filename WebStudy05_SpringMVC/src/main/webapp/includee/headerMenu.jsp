...
<nav class="navbar navbar-dark sticky-top flex-md-nowrap w-100 p-0 border border-secondary">
  ...
  <ul class="nav px-3 col">
    ...
    <li class="nav-item text-nowrap">
      <a class="nav-link" href="${pageContext.request.contextPath }/calendar/calendarList.do">일정</a>
    </li>
     <li class="nav-item text-nowrap">
      <a class="nav-link" href="${pageContext.request.contextPath }/chat/room.do">대화방</a>
    </li>
    <li class="nav-item text-nowrap">
      <a class="nav-link" href="${pageContext.request.contextPath }/chat/bootchat.do">채팅UI</a>
    </li>
    <li class="nav-item text-nowrap">
      <a class="nav-link" href="${pageContext.request.contextPath }/qr.do">qrTest</a>
    </li>
     <li class="nav-item text-nowrap">
      <a class="nav-link" href="${pageContext.request.contextPath }/autumn/chatView.do">autumn용채팅테스트방</a>
    </li>
  ...
  <ul class="nav px-3 col-2">
    ...
    <c:if test="${not empty sessionScope.authMember }">
    	...
    	<input type="hidden" name="memId" value="${sessionScope.authMember.memId }">
    	</form>
	    <li class="nav-item text-nowrap">
